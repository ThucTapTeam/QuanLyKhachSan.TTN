...
--THEM NHAN VIEN
GO
create PROC PROC_INSERT_NHANVIEN @MANV VARCHAR(8),@PASS VARCHAR(30),@HOTEN NVARCHAR(50),@CHUCVU NVARCHAR(20),@GIOITINH NVARCHAR(6),@AVATAR NVARCHAR(200),@NGAYSINH DATE,@PHONE VARCHAR(12) --G.Hải sửa @avatar varchar --> nvarchar
AS
BEGIN
